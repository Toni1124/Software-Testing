module aubrium::xyk_amm {
    ...
    use aptos_framework::coin::{Self, Coin, BurnCapability, MintCapability, FreezeCapability, register};
    ...
    struct FakeMoneyCapabilities<phantom FakeMoneyType> has key {
        ...
        freeze_cap: FreezeCapability<FakeMoneyType>,
    ...
    public entry fun end_to_end(root: signer) acquires Pair {
        ...
        move_to(&root, FakeMoneyCapabilities<FakeMoneyA>{
            mint_cap: mint_cap_a,
            freeze_cap: freeze_cap_a,
            burn_cap: burn_cap_a,
        });
        move_to(&root, FakeMoneyCapabilities<FakeMoneyB>{
            mint_cap: mint_cap_b,
            freeze_cap: freeze_cap_b,
            burn_cap: burn_cap_b,
        });
    }
}
